function [a, fit] = zernike_coeffs_dOTF(phi, M)
...
%           fit - reconstructed phase using ai and Z_i
%
%       USE THE SAME Z_i BASIS AS IRIS AO for dOTF
% 
...
if exist('zernfun.m','file') == 0
    ...
    % Ajout pour remplacer n et m en commentaire plus bas
    n = zeros(1, 105);
    m = zeros(1, 105);
    j = 0.;
    for mode=1:13
